...
public class CarControllerTest {
    ...
    public void updateCar() throws Exception {
        Car car = getCar();
        // Update condition and details of car
        car.setCondition(Condition.NEW);
        Details carDetails = car.getDetails();
        carDetails.setBody("truck");
        carDetails.setModel("Silverado");
    ...
    public void listCars() throws Exception {
        ...
        MvcResult result = mvc.perform(get("/cars")
                ...
                .andReturn();
        JSONObject resultContent = new JSONObject(result.getResponse().getContentAsString());
        JSONArray carList = resultContent.getJSONObject("_embedded").getJSONArray("carList");
        assertTrue(carList.length() == 1);
        JSONObject car = carList.getJSONObject(0);
        assertTrue(car.has("id"));
        assertTrue(car.getInt("id") == 1);
     }
    ...
    public void findCar() throws Exception {
        ...
        MvcResult result = mvc.perform(get("/cars/1")
                ...
                .andReturn();
        JSONObject resultContent = new JSONObject(result.getResponse().getContentAsString());
        assertTrue(resultContent.has("id"));
        assertTrue(resultContent.getInt("id") == 1);
        assertTrue(resultContent.has("condition"));
        assertTrue(resultContent.getString("condition").equals("USED"));
        assertTrue(resultContent.getJSONObject("details").getString("externalColor").equals("white"));
